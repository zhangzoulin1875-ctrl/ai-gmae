  ...
  return (
    <div style={{
      ...
      <div className="card" style={{ maxWidth: '480px', width: '100%', textAlign: 'center' }}>
        <h1 style={{ fontSize: '2.2rem', marginBottom: '0.5rem' }}>1914: THE GREAT WAR</h1>
        <p style={{ color: 'var(--text-muted)', marginBottom: '2rem' }}>
          Global Multiplayer Strategy & Diplomacy Engine
        </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ margin: '1rem 0', display: 'flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-muted)' }}>
        ...
        <div style={{ marginTop: '2rem', fontSize: '0.85rem', color: 'var(--text-muted)' }}>
          <a href="/admin">Admin Access Portal</a>
        </div>
      </div>
    </div>
  );
